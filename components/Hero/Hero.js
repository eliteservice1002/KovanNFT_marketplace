                        ...
                        <div className="col-12 col-md-6 col-lg-7">
                            ...
                            <div className="button-group">
                                <NextLink href="/explore">
                                    <a className="btn btn-bordered-white"><i className="icon-rocket mr-2" />{this.state.data.btn_1}</a>
                                </NextLink>
                                <NextLink  href="/create">
                                    <a className="btn btn-bordered-white"><i className="icon-note mr-2" />{this.state.data.btn_2}</a>
                                </NextLink>
                            </div>
                        </div>
                    </div>
